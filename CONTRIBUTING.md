Contributing to Agenor Core
============================

The Agenor Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/AgenorCoin/Agenor/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Agenor Core project, and is not to be
confused with overall Agenor Network Protocol consensus changes.

Whether a pull request is merged into Agenor Core rests with the project merge
...
Patches that change Agenor consensus rules are considerably more involved than
...
Where a patchset proposes to change the Agenor consensus, it must have been
...
The project leader is the release manager for each Agenor Core release.
